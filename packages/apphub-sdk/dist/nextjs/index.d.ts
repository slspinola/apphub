import { A as AppHubConfig, E as EntityRole, P as Permission, T as TenantContext } from '../types-9KxXXUK5.js';
import { a0 as ScopeFilterConfig } from '../scope-CHFtQhBE.js';
export { aa as AppHubApiError, a as AppHubJWT, c as AppHubOAuthError, G as AuthorizationError, S as ScopeAccessError, a4 as WebhookError, L as applyScopeFilter, ab as createApiClient, a6 as createNextJSWebhookHandler, d as createOAuthClient, a5 as createWebhookProcessor, N as hasAccessToRecord, k as hasAllPermissions, l as hasAnyPermission, Z as hasFullAccess, j as hasPermission, m as hasRole, p as isAdmin, o as isOwner, E as requireAdmin, F as requireOwner, z as requirePermission, D as requireRole } from '../scope-CHFtQhBE.js';
