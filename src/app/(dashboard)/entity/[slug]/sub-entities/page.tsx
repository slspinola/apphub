...
import { FolderTree, Building2, Settings, Users, ArrowLeft, Info } from 'lucide-react'
import Link from 'next/link'

interface EntitySubEntitiesPageProps {
    params: Promise<{ slug: string }>
}

export default async function EntitySubEntitiesPage({ params }: EntitySubEntitiesPageProps) {
